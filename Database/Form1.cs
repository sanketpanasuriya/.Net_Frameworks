...
namespace Database
{
    ...
    {
        //string constring = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Admin\Documents\First_db.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        //    try
        //    {
        //        string insertquery = "insert into [dbUser] (name,email,phone) values(@Name,@Email,@Phone)";
        //        SqlCommand cmd = new SqlCommand(insertquery, con);
        //        cmd.Parameters.AddWithValue("@Name", txt_name.Text);
        //        cmd.Parameters.AddWithValue("@Email", txt_email.Text);
        //        cmd.Parameters.AddWithValue("@Phone", txt_phone.Text);
