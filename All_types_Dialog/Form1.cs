...
namespace All_types_Dialog
{
    public partial class Form1 : Form
    {
        ...
        {
            openFileDialog1.Filter = "Text Files(*.txt)|*.txt|Pictures(*.png)|*.jpg|PDF Files (*.pdf)|*.pdf|All Files (*.*)|*.*";
        ...
        private void saveFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog1.Filter = "Text Files(*.txt)|*.txt|Pictures(*.jpg)|*.jpg|*.png|All Files(*.*)|*.*";
